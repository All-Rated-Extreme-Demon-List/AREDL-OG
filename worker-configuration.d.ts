/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: fe3cfb6dbac0d9ff0ca805be4c099793)
// Runtime types generated with workerd@1.20251105.0 2025-11-10 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import('./src/routes/root');
    }
    interface Env {
        API_BASE_URL:
            | 'https://api.aredl.net/v2/api'
            | 'https://api.aredl.net/v2dev/api';
        ASSETS: Fetcher;
        OG_DATA_SECRET: string;
    }
}
